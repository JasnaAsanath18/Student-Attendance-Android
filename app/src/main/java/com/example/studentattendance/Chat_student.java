...
public class Chat_student extends Activity  implements JsonResponse
{
    EditText ed1;
    ImageView b1;
    String chat;
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View arg0)
            {
                ...
                else
                {
                    ...
                    JR.json_response=(JsonResponse) Chat_student.this;
                    String q = "/chat_with_student?mg="+chat+"&tid="+Chat_St.teacher_id+"&logid="+sh.getString("log_id","");
                    q=q.replace(" ","%20");
                    JR.execute(q);
...
//		{
        ...
        JsonReq JR=new JsonReq();
        JR.json_response=(JsonResponse) Chat_student.this;
        String q = "/view_chat_with_student?logid="+sh.getString("log_id","")+"&tid="+Chat_St.teacher_id;
        q=q.replace(" ", "%20");
        JR.execute(q);
...
//					 Toast.makeText(getApplicationContext(), "Added", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(),Chat_student.class));
