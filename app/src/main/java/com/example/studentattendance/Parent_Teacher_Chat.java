...
public class Parent_Teacher_Chat extends Activity  implements JsonResponse
{
    EditText ed1;
    ImageView b1;
    String chat;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        l1=(ListView)findViewById(R.id.listView11);
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View arg0)
            {
                ...
                else
                {
                    ...
                    JR.json_response=(JsonResponse) Parent_Teacher_Chat.this;
                    String q = "/chat_with_parent?mg="+chat+"&tid="+Chat_St.teacher_id+"&logid="+sh.getString("log_id","");
                    q=q.replace(" ","%20");
                    JR.execute(q);
...
//		{
        ...
        JsonReq JR=new JsonReq();
        JR.json_response=(JsonResponse) Parent_Teacher_Chat.this;
        String q = "/view_chat_with_parent?logid="+sh.getString("log_id","")+"&tid="+Chat_St.teacher_id;
        q=q.replace(" ", "%20");
        JR.execute(q);
...
//						r_id[i]=ja1.getJSONObject(i).getString("receiver_id");
                        message[i]=ja1.getJSONObject(i).getString("messages");
...
//					 Toast.makeText(getApplicationContext(), "Added", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(),Parent_Teacher_Chat.class));
