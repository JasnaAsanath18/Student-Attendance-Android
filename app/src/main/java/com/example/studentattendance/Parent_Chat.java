...
public class Parent_Chat extends AppCompatActivity implements JsonResponse{
    ListView list1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response=(JsonResponse)Parent_Chat.this;
        String q="/parent_view_teacher";
        q = q.replace(" ", "%20");
        JR.execute(q);
...
//                amnt=amount[i];
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Parent_Chat.this);
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        {
                            Intent il=new Intent(getApplicationContext(),Parent_Teacher_Chat.class);
                            startActivity(il);
                        }
